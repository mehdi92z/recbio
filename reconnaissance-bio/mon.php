...
Reconnaisance d'image                    </header>
                    <div class="panel-body">
                        <form method="post" action="test.php" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="exampleInputEmail1"><b>Veuillez entrer l'image test</b></label>
                                              <input type="file" name="fichier">
                            </div>
                             
                            <button type="submit" class="btn btn-primary" name="ajouter">tester</button>
                        </form>
