...
Ajouter une image                    </header>
                    <div class="panel-body">
                         <form method="post" action="ajoutMehdi.php" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Inserer une image</label>
                                <input type="file" class="form-control" name="image" >
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">donner un nom a l'image</label>
                                <input type="text" class="form-control" name="nom" >
                            </div>
                             
                             <button type="submit" class="btn btn-primary" name="ajouter" onclick="alert('votre image a bien ete ajouter')">ajouter</button>
